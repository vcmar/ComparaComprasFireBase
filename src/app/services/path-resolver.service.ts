import { paths } from './../common/app-routing/app.paths';
...
export class PathResolverService implements Resolve<string | null> {
  ...
  /**
   * Extracted from: https://blog.angularindepth.com/angular-smart-404-page-85a45b109fd8
   * https://github.com/vitaliy-bobrov/ngx-smart-routing-demo/blob/master/src/app/path-resolve.service.ts
